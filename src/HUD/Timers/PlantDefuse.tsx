        ...
        if (type === "defusing") {
            return (
                <>
                    ...
                    />
                    <div className={"CT"}>{player.name} DEFUSING</div>
                </>
            );
        }
        return (
            <>
                <I.SmallBomb height={30} fill="var(--color-new-t)" />
                <div className={"T"}>{player.name} PLANTING</div>
            </>
        );
    };
    render() {
        ...
        return (
            ...
            >
                ...
                <div
                    ...
                    style={{ width: `${(timer && timer.width) || 0}%` }}
                ></div>
            </div>
        );
    }
